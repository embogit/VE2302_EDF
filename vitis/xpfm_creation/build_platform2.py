...
platform = client.create_platform_component(name = "versal-generic-xcve2302_platform_linked",hw_design = rootdir + "/vitis/build/platform/versal-generic-xcve2302_linked.xsa",os = "linux",cpu = "psv_cortexa72",domain_name = "linux_psv_cortexa72",generate_dtb = True,advanced_options = advanced_options)

platform = client.get_component(name="versal-generic-xcve2302_platform_linked")
...
status = domain.set_boot_dir(path=rootdir + "/vitis/build/boot")
